...
public class InformerRegActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // FirebaseDatabase.getInstance().setLogLevel(Logger.Level.DEBUG);
        ...
        email_str = recievedIntent.getStringExtra("email");
        name_str=recievedIntent.getStringExtra("name");
        ...
        if(email_str!=null){
            ...
            submit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    boolean status=attemptRegistration_gac();
    ...
    private boolean attemptRegistration_gac() {
